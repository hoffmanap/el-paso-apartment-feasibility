...
An interactive geospatial and machine learning dashboard designed to analyze existing multifamily parcels across El Paso, Texas. By leveraging historical parcel geometries, zoning classifications, and localized geographic context layers, this application utilizes machine learning models to predict optimal building envelopes, massing configurations, and design typologies.
