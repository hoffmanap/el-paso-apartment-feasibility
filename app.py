...
if gdf is None:
    ...
    with col2:
        ...
        # Bounding mass fallbacks
        avg_height = get_safe_mean(active_source, height_col, 24.0 if avg_far < 1.0 else 45.0)
        ...
        # Dynamically predict box typology shape metrics based on building proportions
